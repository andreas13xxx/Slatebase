...
export const de = {
  ...
  sync: {
    ...
    triggerSync: 'Sync starten',
    syncing: 'Synchronisiere…',
    resultSuccess: 'Sync erfolgreich',
    resultFailed: 'Sync fehlgeschlagen',
    ...
    conflictWizard: {
      ...
      stepsOverview: 'Übersicht',
      stepsCategoryDetail: 'Kategorie-Details',
      stepsResolution: 'Auflösung',
      categoriesContentConflict: 'Inhaltskonflikte',
      categoriesLocalDeleted: 'Lokal gelöscht',
      categoriesRemoteDeleted: 'Remote gelöscht',
      categoriesRenameConflict: 'Umbenennung',
      recommendationsContentConflict: 'Neuere Version',
      recommendationsLocalDeleted: 'Remote-Version wiederherstellen',
      recommendationsRemoteDeleted: 'Lokale Version behalten',
      recommendationsRenameConflict: 'Remote-Pfad übernehmen',
      progress: '{resolved}/{total} Konflikte gelöst',
      allResolved: 'Alle Konflikte gelöst',
      resumeSync: 'Sync fortsetzen',
      buttonsResolveAll: 'Alle auflösen',
      buttonsUseLocal: 'Lokale Version',
      buttonsUseRemote: 'Remote-Version',
      buttonsManualMerge: 'Manuell mergen',
      buttonsSkip: 'Überspringen',
      buttonsConfirm: 'Bestätigen',
      buttonsCancel: 'Abbrechen',
      buttonsNext: 'Weiter',
      buttonsBack: 'Zurück',
      batchTitle: 'Batch-Auflösung',
      batchConfirm: '{count} Konflikte mit Strategie „{strategy}" auflösen?',
      batchLimitExceeded: 'Maximal 100 Konflikte pro Batch. Bitte Auswahl aufteilen.',
      batchResult: '{succeeded} erfolgreich, {failed} fehlgeschlagen',
      batchErrorsToggle: '{count} Fehler anzeigen',
      batchProcessing: 'Wird verarbeitet…',
      diffSideBySide: 'Nebeneinander',
      diffUnified: 'Vereint',
      diffIdenticalLines: '{count} identische Zeilen',
      diffBinaryFile: 'Binärdatei — kein Text-Diff verfügbar',
      diffLocalVersion: 'Lokal',
      diffRemoteVersion: 'Remote',
      mergeTitle: 'Manueller Merge',
      mergePreview: 'Vorschau',
      mergeEditor: 'Editor',
      autoResolutionTitle: 'Automatische Auflösung',
      autoResolutionEnabled: 'Aktiviert',
      autoResolutionDisabled: 'Deaktiviert',
      autoResolutionNewerWins: 'Neuere Version gewinnt',
      autoResolutionRemoteWins: 'Remote gewinnt immer',
      autoResolutionLocalWins: 'Lokal gewinnt immer',
      autoResolutionSkip: 'Überspringen',
      errorsLoadFailed: 'Konflikte konnten nicht geladen werden',
      errorsResolveFailed: 'Auflösung fehlgeschlagen',
      errorsContentUnavailable: 'Dateiinhalt nicht verfügbar',
      newConflicts: 'Neue Konflikte erkannt',
      newConflictDetected: 'Neuer Sync-Konflikt erkannt — Liste aktualisiert',
      paginationPage: 'Seite {page} von {total}',
      loading: 'Konflikte werden geladen…',
      completionTitle: 'Alle Konflikte gelöst',
      completionSummary: '{count} Konflikte erfolgreich aufgelöst',
      conflictsResolved: 'Konflikte gelöst',
      batchError: 'Batch-Auflösung fehlgeschlagen',
      batchResultSuccess: '{count} erfolgreich aufgelöst',
      batchResultFailed: '{count} fehlgeschlagen',
      resolveAll: 'Alle auflösen',
      back: 'Zurück',
      selectedCount: '{count} ausgewählt',
      processing: 'Wird verarbeitet…',
      resolveSelected: 'Ausgewählte auflösen',
      ...
      unified: 'Vereint',
      diffPlaceholder: 'Wählen Sie einen Konflikt, um den Diff anzuzeigen',
      useLocal: 'Lokale Version verwenden',
  ...
  graph: {
    ...
    colors: 'Farben',
    colorFile: 'Datei',
    colorUnresolved: 'Unaufgelöst',
    colorTag: 'Tag',
    colorProperty: 'Property',
    colorEdge: 'Kanten',
    colorHighlight: 'Hervorhebung',
    layout: 'Layout',
    repulsion: 'Abstoßung',
    linkStrength: 'Anziehung',
    linkDistance: 'Distanz',
    centerGravity: 'Schwerkraft',
  ...
  pluginStore: {
    tabInstalled: 'Installierte Plugins',
    tabAvailable: 'Verfügbare Plugins',
    searchPlaceholder: 'Plugin suchen…',
    searchAriaLabel: 'Plugin-Store durchsuchen',
    filterCompatible: 'Kompatibel',
    filterNotInstalled: 'Nicht installiert',
    resultCounter: '{filteredCount} von {totalCount} Plugins',
    ...
    updatesAvailable: '{count} Updates verfügbar',
    updateAll: 'Alle aktualisieren',
    updatingAll: 'Updates werden installiert…',
    bulkResult: '{updated} aktualisiert, {failed} fehlgeschlagen',
    ...
    allUpToDate: 'Alle Plugins sind aktuell',
    detailClose: 'Schließen',
    detailLoadingReadme: 'README wird geladen…',
    detailReadmeError: 'README konnte nicht geladen werden',
    detailNoReadme: 'Keine README verfügbar',
    detailBy: 'von',
