...
export const de = {
  ...
  contextPanel: {
    ...
    properties: {
      ...
      noDocument: 'Kein Dokument geöffnet.',
      notMarkdown: 'Keine Eigenschaften für diesen Dateityp',
      deleteProperty: 'Eigenschaft entfernen',
      deletePropertyAriaLabel: '{key} entfernen',
      addProperty: 'Eigenschaft hinzufügen',
      renamePropertyTitle: 'Zum Umbenennen klicken',
      propertyNameAriaLabel: 'Name der Eigenschaft',
      typeAriaLabel: 'Typ',
      types: {
        text: 'Text',
        number: 'Zahl',
    ...
    propertiesOverview: {
      ...
      loadError: 'Eigenschaften konnten nicht geladen werden.',
      empty: 'Keine Eigenschaften in diesem Vault gefunden.',
    ...
    propertyControls: {
      ...
      removeItemAriaLabel: '{item} entfernen',
      dateAriaLabel: 'Datum',
      dateTimeAriaLabel: 'Datum und Zeit',
      emptyValue: '(leer)',
    },
    noDocument: 'Kein Dokument geöffnet',
  ...
  search: {
    placeholder: 'Suchen...',
    inputAriaLabel: 'Suchen',
    caseSensitive: 'Groß-/Kleinschreibung',
    regex: 'Regulärer Ausdruck',
    operatorHelpButton: 'Operatoren-Hilfe',
    collapseReplace: 'Ersetzen einklappen',
    expandReplace: 'Ersetzen ausklappen',
    replaceSectionAriaLabel: 'Ersetzen-Bereich umschalten',
    replace: 'Ersetzen',
    replacePlaceholder: 'Ersetzen...',
    replaceAll: 'Alle ersetzen',
    replaceAllTitle: 'Alle Treffer ersetzen',
    scopeAriaLabel: 'Suchbereich',
    scopeCurrentVault: 'Aktueller Vault',
    scopeAllVaults: 'Alle Vaults',
    searching: 'Suche läuft...',
    noResults: 'Keine Ergebnisse',
    replacing: 'Ersetzen läuft...',
    hitsCount: '{count} Treffer',
    filesCount: '{count} Datei(en)',
    replaceFileTitle: 'Treffer in {fileName} ersetzen',
    replaceFileAriaLabel: 'Ersetzen in {fileName}',
    confirmReplaceAllTitle: 'Alle ersetzen',
    confirmReplaceAllMessage: '{hitCount} Treffer in {fileCount} Datei(en) ersetzen?',
    replaceSuccess: '{count} Ersetzung(en) in {fileCount} Datei(en) durchgeführt',
    replaceNoHits: 'Keine Treffer zum Ersetzen gefunden',
    operatorHelp: {
      ariaLabel: 'Suchoperatoren',
      title: 'Suchoperatoren',
      columnOperator: 'Operator',
      columnExample: 'Beispiel',
      columnDescription: 'Beschreibung',
      note: 'Werte mit Leerzeichen in Anführungszeichen setzen:',
      operators: {
        path: 'Dateien im Pfad einschließen',
        file: 'Dateien mit passendem Namen',
        tag: 'Dateien mit dem Tag',
        property: 'Dateien mit der Eigenschaft',
        propertyValue: 'Eigenschaft mit Wert',
        excludePath: 'Pfad ausschließen',
        excludeTag: 'Tag ausschließen',
        excludeProperty: 'Eigenschaft ausschließen',
      },
    },
  },

  math: {
    renderTimeout: 'Rendering-Zeitüberschreitung',
  },
  ...
  statusBar: {
    ...
    linkCounts: '{forward} aus- / {backlinks} eingehend',
    linkCountsAriaLabel: 'Anzahl aus- und eingehender Links',
