...
export const en: TranslationShape = {
  ...
  sync: {
    ...
    conflictWizard: {
      ...
      stepsOverview: 'Overview',
      stepsCategoryDetail: 'Category Details',
      stepsResolution: 'Resolution',
      categoriesContentConflict: 'Content Conflicts',
      categoriesLocalDeleted: 'Locally Deleted',
      categoriesRemoteDeleted: 'Remotely Deleted',
      categoriesRenameConflict: 'Rename Conflicts',
      recommendationsContentConflict: 'Newer Version',
      recommendationsLocalDeleted: 'Restore Remote Version',
      recommendationsRemoteDeleted: 'Keep Local Version',
      recommendationsRenameConflict: 'Use Remote Path',
      progress: '{resolved}/{total} Conflicts Resolved',
      allResolved: 'All Conflicts Resolved',
      resumeSync: 'Resume Sync',
      buttonsResolveAll: 'Resolve All',
      buttonsUseLocal: 'Use Local',
      buttonsUseRemote: 'Use Remote',
      buttonsManualMerge: 'Manual Merge',
      buttonsSkip: 'Skip',
      buttonsConfirm: 'Confirm',
      buttonsCancel: 'Cancel',
      buttonsNext: 'Next',
      buttonsBack: 'Back',
      batchTitle: 'Batch Resolution',
      batchConfirm: 'Resolve {count} conflicts with strategy "{strategy}"?',
      batchLimitExceeded: 'Maximum 100 conflicts per batch. Please split selection.',
      batchResult: '{succeeded} succeeded, {failed} failed',
      batchErrorsToggle: 'Show {count} errors',
      batchProcessing: 'Processing…',
      diffSideBySide: 'Side by Side',
      diffUnified: 'Unified',
      diffIdenticalLines: '{count} identical lines',
      diffBinaryFile: 'Binary file — no text diff available',
      diffLocalVersion: 'Local',
      diffRemoteVersion: 'Remote',
      mergeTitle: 'Manual Merge',
      mergePreview: 'Preview',
      mergeEditor: 'Editor',
      autoResolutionTitle: 'Auto-Resolution',
      autoResolutionEnabled: 'Enabled',
      autoResolutionDisabled: 'Disabled',
      autoResolutionNewerWins: 'Newer Version Wins',
      autoResolutionRemoteWins: 'Remote Always Wins',
      autoResolutionLocalWins: 'Local Always Wins',
      autoResolutionSkip: 'Skip',
      errorsLoadFailed: 'Failed to load conflicts',
      errorsResolveFailed: 'Resolution failed',
      errorsContentUnavailable: 'File content unavailable',
      newConflicts: 'New conflicts detected',
      newConflictDetected: 'New sync conflict detected — list updated',
      paginationPage: 'Page {page} of {total}',
      loading: 'Loading conflicts…',
      completionTitle: 'All Conflicts Resolved',
      completionSummary: '{count} conflicts successfully resolved',
      conflictsResolved: 'conflicts resolved',
      batchError: 'Batch resolution failed',
      batchResultSuccess: '{count} resolved successfully',
      batchResultFailed: '{count} failed',
      ...
      unified: 'Unified',
      diffPlaceholder: 'Select a conflict to view the diff',
      useLocal: 'Use Local',
