...
export const SETTINGS_SECTIONS: ISettingsSectionDef[] = [
  ...
  { id: 'mcp-tokens', labelKey: 'settings.sections.mcpTokens', category: 'account', requiresAdmin: false, requiresVault: false, feature: 'mcp' },
  ...
  { id: 'my-vaults', labelKey: 'settings.sections.myVaults', category: 'account', requiresAdmin: false, requiresVault: false },
  ...
  { id: 'plugins', labelKey: 'settings.sections.plugins', category: 'vault', requiresAdmin: false, requiresVault: true, feature: 'obsidian-plugin-compat' },
