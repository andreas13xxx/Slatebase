...
export type AccountSection = 'profile' | 'password' | 'sessions' | 'mcp-tokens' | 'delete-account' | 'keybindings' | 'appearance'
...
const CATEGORY_SECTIONS: Record<SettingsCategory, SettingsSection[]> = {
  account: ['profile', 'password', 'sessions', 'mcp-tokens', 'keybindings', 'appearance', 'delete-account'],
